...
import { Button, Divider, Space, Switch, Tabs, Tooltip } from '@youknown/react-ui/src'
...
export function ButtonIcon() {
  return (
    <Space>
      <Button prefixIcon={<TbSearch />}>Prefix</Button>
      <Button suffixIcon={<TbSearch />}>Suffix</Button>
    </Space>
  )
}
