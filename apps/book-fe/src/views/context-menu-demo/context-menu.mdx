...
export function BasicUsage() {
  ...
  return (
    <>
      <div
        className="flex justify-center items-center w-200px h-160px b-1 b-solid b-#ddd"
...
export default () => {
  ...
  return (
    <>
      <div
        className="flex justify-center items-center w-200px h-160px b-1 b-solid b-#ebebeb"
        onContextMenu={onContextMenu}
      >
        Right click menu
      </div>
