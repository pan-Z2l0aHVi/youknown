...
```tsx
import { Divider, Image } from '@youknown/react-ui'
...
export function ImageCanNotPreview() {
  return <Image src={picSrc} width="300px" />
}
...
```tsx
import { Button, Image, Space } from '@youknown/react-ui'
...
export function MultiImage() {
  const imageList = [
    'https://iph.href.lu/200x100',
    'https://iph.href.lu/400x200',
    'https://iph.href.lu/800x400',
    'https://iph.href.lu/1600x800'
  ]
  return (
    <Space>
      <Button
