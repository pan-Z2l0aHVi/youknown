...
export function loadLanguages() {
	return Promise.allSettled([
		...
		import('highlight.js/lib/languages/javascript').then(langFactory('javascript')).then(() => {
		...
		import('highlight.js/lib/languages/markdown').then(langFactory('markdown')).then(() => {
		...
		import('highlight.js/lib/languages/typescript').then(langFactory('typescript')).then(() => {
